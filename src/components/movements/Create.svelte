<script lang="ts">
    import { type MovementItem } from './movements.svelte';
    ...
    async function submitMovement(e: Event) {
        ...
        await movementModel.createMovement({ type, userId, items });
        resetForm();
    }
</script>
        ...
        <div class="bg-white rounded-md p-4 w-96">
            <form onsubmit={submitMovement}>
                ...
                <div class="p-2 flex flex-col">
                    <label for="userId" class="block text-sm font-bold">Usuario:</label>
                ...
                <div class="p-2 flex flex-col">
                    <label for="type" class="block text-sm font-bold">Tipo:</label>
